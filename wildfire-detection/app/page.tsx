...
const HomePage = () => {
  ...
  return (
    ...
    {/* Project Description Section */}
      ...
      <div className="relative bg-gradient-to-b from-black to-gray-900 py-20 px-6 z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group relative bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-2xl border border-orange-500/20 hover:border-orange-500/50 transition-all duration-300 backdrop-blur-sm">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-bold mb-4 text-white">Autonomous Rover Deployment</h3>
                <p className="text-gray-300 leading-relaxed mb-6">A SparkFun RedBoard-powered rover navigates remote areas to assist in evacuation and deliver aid.</p>
            ...
            <div className="group relative bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-2xl border border-orange-500/20 hover:border-orange-500/50 transition-all duration-300 backdrop-blur-sm">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-bold mb-4 text-white">Early Risk Detection</h3>
                <p className="text-gray-300 leading-relaxed mb-6">Integrated temperature and humidity sensors (HTU21D) detect sudden local spikes in temperature and low humidity, early indicators of potential flames.</p>
            ...
            <div className="group relative bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-2xl border border-orange-500/20 hover:border-orange-500/50 transition-all duration-300 backdrop-blur-sm">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-bold mb-4 text-white">Interactive Fire Map</h3>
                <p className="text-gray-300 leading-relaxed mb-6">Real-time mapping of detected wildfires for situational awareness.</p>
            ...
            <div className="group relative bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-2xl border border-orange-500/20 hover:border-orange-500/50 transition-all duration-300 backdrop-blur-sm">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-bold mb-4 text-white">Environmental Network</h3>
                <p className="text-gray-300 leading-relaxed mb-6">Connected sensor network monitoring environmental conditions across Canadian territories for comprehensive wildfire risk assessment.</p>
            ...
            <div className="group relative bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-2xl border border-orange-500/20 hover:border-orange-500/50 transition-all duration-300 backdrop-blur-sm">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-bold mb-4 text-white">Alert System</h3>
                <p className="text-gray-300 leading-relaxed mb-6">Notifies residents and emergency services of wildfire presence to expedite evacuation and response.</p>
